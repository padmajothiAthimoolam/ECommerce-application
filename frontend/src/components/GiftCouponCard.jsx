      ...
      <div className='space-y-4'>
        <div>
            ...
            <input
                type='text'
                id="voucher"
                className='block w-full rounded-lg border-gray-600 bg-gray-700 px-4 p-2.5 text-sm text-white placeholder-gray-400 focus:border-emerald-500 focus:ring-emerald-500'
        ...
        <motion.button
        type="button"
        className='flex w-full items-center justify-center rounded-lg bg-emerald-600 px-5 py-2.5 text-sm font-medium text-white hover:bg-emerald-700 focus:outline-none focus:ring-emerald-500'
