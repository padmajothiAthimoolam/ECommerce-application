...
const NavBar = () => {
  ...
  return (
    <header className='fixed top-0 left-0 w-full bg-gray-900 bg-opacity-90 backdrop-blur-md shadow-lg z-40 transition-all duration-300 border-b border-emrald-800'>
                ...
                <nav className='flex flex-wrap items-center gap-4'>
                    ...
                    {user && (
                        ...
                        className='relative group text-gray-300 hover:text-emerald-400 transition duration-300 ease-in-out'>
                            ...
                            <span className='hiden sm:inline'>Cart</span>
